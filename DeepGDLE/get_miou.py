...
if __name__ == "__main__":
    ...
    #name_classes = ["_background_", "bare soil", "building", "pavement", "road", "vegetation", "water"]
    name_classes = ["_background_", "field", "forest", "water", "road", "building", "parking", "railway", "playground"]
    #-------------------------------------------------------#
    #   指向VOC数据集所在的文件夹
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
