...
if __name__ == '__main__':
    ...
    #classes = ["_background_", "bare soil", "building", "pavement", "road", "vegetation", "water"]
    classes  = ["_background_", "field", "forest", "water", "road", "building", "parking", "railway", "playground"]
