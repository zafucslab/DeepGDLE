...
def ghostnet(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_url('https://github.com/huawei-noah/Efficient-AI-Backbones/blob/master/ghostnet_pytorch/models/state_dict_73.98.pth'), strict=False)
    return model
